...
--Business Problem :- Comapny does not know which category contributes most of revenue.

-- Impact :- 
        --Helps prioitize high performing category 
...
-- Business Problem:- Lack of undersatnding of revenue cintribution by the gender segment

--Impact
        --Help design targeted marketing campaign
        --Improves customer segmentation strategy
        --Inhance personalization efforts
...
-- Impact :-
    --Identifies best-selling/highly-rated products
    --Highlights products needing improvement
    --Improves overall customer satisfaction and brand loyalty
...
-- Impact :- 
    ...
    --Identifies high-value shipping methods
    --Increases customer satisfaction and revenue


--7. Do subscribes customers spend more? Compare average speed and total revenue between subscribers anf non sunscribers.
...
-- Impact :-
    --Identifies products with high discount dependency
    --Helps in adjusting pricing strategies to maintain margins
    --Enables better inventory and promotion planning
...
-- Impact :-
    ...
    --Helps in resource allocation for different customer groups
    --Increases customer engagement and conversion rates


--10. What are the top 3 most purchased products with each category ?
...
--11. Are customer who are repeat buyers (more then 5 previous purchases) also likely to subscribe ?
...
-- Impact :-
    --Tailor marketing campaigns for high-revenue age groups
    --Optimize product offerings for specific demographics
    --Improve overall ROI on marketing spend